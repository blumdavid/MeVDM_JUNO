""" test2:
    ...
    1. step:
        ...
        n_i:    observed number of events per bin (S*f_s + B1*f_B1,i + B2*f_B2,i + B3*f_B3,i + B4*f_B4,i)
    ...
    ERROR:
    the observed number of events n_i must be fixed and v_i must contain free parameters, because the number of
    observed events n_i should be fix after a measurement!
