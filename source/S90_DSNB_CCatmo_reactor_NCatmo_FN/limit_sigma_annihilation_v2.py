""" Script "limit_sigma_annihilation_v2.py" from 30.10.2019.
    ...
    Results of the simulation and analysis saved in folder "S90_DSNB_CCatmo_reactor_NCatmo_FN"

    Information about the expected signal and background spectra generated with gen_spectrum_v3.py:
    ...
    - expected spectrum of DSNB is saved in file: DSNB_EmeanNuXbar22_bin500keV_PSD.txt
    - information about the expected spectrum is saved in file: DSNB_info_EmeanNuXbar22_500keV_PSD.txt
    ...
    Atmospheric Charged Current electron-antineutrino Background:
    - expected spectrum of atmospheric CC background is saved in file: CCatmo_Osc0_bin500keV_PSD.txt
    - information about the atmospheric CC background spectrum is saved in file: CCatmo_info_Osc0_bin500keV_PSD.txt
    ...
    Atmospheric fast neutron Background:
    - expected spectrum of fast neutron background is saved in file: fast_neutron_33events_bin500keV_PSD.txt
    - information about the FN background spectrum is saved in file: fast_neutron_info_33events_bin500keV_PSD.txt
...
plt.fill_between(DM_mass, limit_S_90_84, limit_S_90_97_5, facecolor='yellow', alpha=1,
                 label='95 % probability interval')
plt.xlim(np.min(DM_mass), np.max(DM_mass))
plt.ylim(0, np.max(limit_S90_97_5))
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
plt.xlabel("Dark Matter mass in MeV", fontsize=15)
