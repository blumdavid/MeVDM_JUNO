""" Script "output_analysis_v6.py" from 13.08.2020.
    It was used for simulation and analysis of "S90_DSNB_CCatmo_NCatmo".

    output_analysis_v6.py:

    The Script is a function to display and analyze the results of the MCMC analysis.

    The MCMC analysis is done either with analyze_spectra_v8_local.py or with analyze_spectra_v8_server2.py.

    The script output_analysis_v6.py is used in the script output_analysis_v6_server.py
...
def output_analysis(save_data, dm_mass, path_output, path_analysis, file_info_analysis, file_number_start,
    ...
    # number of expected atmospheric CC background events on C12 in the energy window (float):
    ccatmo_c12_expected = information_analysis[8]
