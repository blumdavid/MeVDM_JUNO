...
""" Script "auto_output_analysis_v4.py" from 13.08.2020.
    It was used for simulation and analysis of "S90_DSNB_CCatmo_NCatmo".

    auto_output_analysis_v4.py is a script to automate the display of the analysis of the
    indirect MeV-Dark Matter search with JUNO!
...
# TODO: Check if "output_analysis_v6.py", "output_analysis_v6_server.py" and "auto_output_analysis_v6.py" in same folder
...
for DM_mass in masses:
    ...
    """ Description of the arguments for the output_analysis_v6_server.py script:
        - sys.argv[0] name of the script = output_analysis_v6_server.py
        - sys.argv[1] Dark matter mass in MeV
        - sys.argv[2] directory of the correct folder = "/junofs/users/dblum/work/S90_DSNB_CCatmo_reactor_NCatmo_FN"
    ...
    output_analysis_process = subprocess.Popen(['python output_analysis_v6_server.py %d %s %s %d %d %d'
