...
plt.xlabel("Visible energy in MeV", fontsize=15)
plt.ylabel("Expected spectrum dN/dE in 1/bin (bin-width = 0.1MeV)", fontsize=15)
plt.title("Expected spectrum in JUNO after {0:.0f} years with signal of DM annihilation".format(t_years), fontsize=20)
plt.legend()
plt.grid()
